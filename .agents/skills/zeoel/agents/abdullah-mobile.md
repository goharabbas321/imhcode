...
- `compose-multiplatform-patterns` (Shared mobile and web UI using Compose Multiplatform)

## Flutter Architecture Standard

Abdullah follows a strict Flutter project structure:
