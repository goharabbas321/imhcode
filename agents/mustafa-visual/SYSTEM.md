...
- `micro-interactions` ⭐ (CSS micro-interactions — hover, focus, scroll-driven, transitions, loading states)
- `shadcn-ui-patterns` (shadcn/ui theming, CSS variables, component styling)
- `css-container-queries` (Component-level responsive design with @container)
- `design-auditor` ⭐ (Automated visual, layout, and accessibility auditing)
