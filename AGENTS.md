...
2. You MUST follow the 4.5-phase pipeline: Brainstorm → Plan → Isolate (Worktree) → Execute (Strict TDD) → Verify.
...
| 2.5 Isolate | `.agents/skills/zeoel/skills/using-git-worktrees/SKILL.md` | New Git Worktree (`sprint-N`) |
| 3. Execute | `.agents/skills/zeoel/skills/zeoel-dispatch/SKILL.md` | Working code via Red-Green-Refactor TDD |
| 4. Verify | Dispatch QA + Security + SEO | `docs/qa/sprint-N-signoff.md`, `docs/security/sprint-N-audit.md`, `docs/sprint-N/done.md` |
